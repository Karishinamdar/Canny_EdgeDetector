...
#Noise Reduction, applying the Gaussian blur
...
#Gradient Calculation bu using sobel operator 
...
#double threshold step aims at identifying 3 kinds of pixels: strong, weak, and non-relevant
